...
<div>
	...
	<a href="#" class="btndelay" onclick="return addToCartDelay('q_<?=$arResult["ID"]?>','<?=$base_quantity?>');" style="margin-left: 4px;"><img style="margin-right: 11px;margin-bottom: -5px;" src="/images/time.png">ОТЛОЖИТЬ</a>
    <?
