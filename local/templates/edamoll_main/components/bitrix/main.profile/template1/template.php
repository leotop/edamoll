...
<tr>
	...
	<td><input type="text" name="PERSONAL_BIRTHDAY" maxlength="50" value="<?=$arResult["arUser"]["PERSONAL_BIRTHDAY"]?>" />
<?/*
...
<table class="data-table profile-table">
	...
	<p><input class="personal_sbmt" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>"></p>
</form>
</div>