...
<div class="b-feedBack" style="margin-left: 175px; float: left;">
		...
		<div class="b-feedBack-form">
			...
			<div class="b-feedBack-row">
				<label>Телефон</label>
				<input type="text" name="form_text_5" value="<?=$arResult["arrVALUES"]["form_text_5"];?>">
			</div><!-- .b-feedBack-row -->
			<div class="b-feedBack-row">
				<label>Email</label>
				<input type="text" name="form_text_6" value="<?=$arResult["arrVALUES"]["form_text_6"];?>">
				<input type="text" name="form_text_9" hidden="true" value="<?=getOS($_SERVER['HTTP_USER_AGENT']);?>">
				<input type="text" name="form_text_11" hidden="true" value="<?=getRealIp();?>">
				<input type="text" name="form_text_10" hidden="true" value="<?=getUserBrowser($_SERVER['HTTP_USER_AGENT']);?>">
			</div><!-- .b-feedBack-row -->
			<div class="b-feedBack-row">
				<label>Текст обращения<span class="b-feedBack-star">*</span></label>
				<textarea name="form_textarea_4"><?=$arResult["arrVALUES"]["form_textarea_4"];?></textarea>
			</div><!-- .b-feedBack-row -->
