...
<?
?>
<h2 class="order_main_h">ќформление заказа</h2>
...
*/?>
		...
		<?if($_POST["is_ajax_post"] != "Y")
		{
			?>
				...
				<div align="right">
				<input type="button" class="personal_sbmt" name="submitbutton" onClick="submitForm('Y');" value="<?=GetMessage("SOA_TEMPL_BUTTON")?>">
				</div>
			</form>
