...
if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)
	die();
?>
<div style="float:left;margin:20px;width:270px;">

<?if($USER->IsAuthorized()):?>

	<p style="font-size:12pt;"><?echo GetMessage("MAIN_REGISTER_AUTH")?></p>
<?else:?>
...
<table>
	<thead>
		<tr>
			<td colspan="2" style="text-align: left;font-size:12pt;"><b><?=GetMessage("AUTH_REGISTER")?></b></td>
		</tr>
<tr>
	<td colspan="2" style="color:rgb(255,0,57);text-align: left;">следующие поля обязательны<br /> для заполнения</td></tr>
	</thead>
	<tbody>
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	<?else:?>
		<tr>
			<td colspan="2" style="height: 30px;text-align: left;color: rgb(94,94,94);"><?=GetMessage("REGISTER_FIELD_".$FIELD)?></td></tr><tr>
			<td colspan="2"><?
	switch ($FIELD)
	{
		case "PASSWORD":
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td style="text-align: right;"><input id="register_submit_button1"  type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
