...
<div class="pinktext">Отзывы покупателей</div>
<div class="reviews-block-container reviews-reviews-block-container">
<div class="reviews-block-outer">
  <div class="reviews-block-inner">
	Пока никто не оставил отзывов о товаре.<br />
...
<div class="reviews-reply-form" <?=(($arParams['SHOW_MINIMIZED'] == "Y")?'style="display:none;"':'')?>>
	<div class="pinktext">оставить отзыв</div>
...
if (!$arResult["IS_AUTHORIZED"]):
  if($arResult["REVIEW_AUTHOR"]=="Guest")
	...
	<div class="reviews-reply-fields">
		<div class="reviews-reply-field-user">
			<div class="reviews-reply-field reviews-reply-field-author"><label for="REVIEW_AUTHOR<?=$arParams["form_index"]?>"><?=GetMessage("OPINIONS_NAME")?><?
				...
				<span><input placeholder="Введите ваше имя" name="REVIEW_AUTHOR" id="REVIEW_AUTHOR<?=$arParams["form_index"]?>" size="30" type="text" value="<?=$arResult["REVIEW_AUTHOR"]?>" tabindex="<?=$tabIndex++;?>" /></span>
        <span id="error_name" style="color:  #FF0039"></span>
      </div>
<?		
...
?>
	<div class="reviews-reply-header"><span>Ваш отзыв</span></div>
...
?>        <span id="error_message" style="color:  #FF0039"></span>
